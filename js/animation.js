  ...
  switch (activeCorner) {
    ...
    case "bottom-left":
      if (window.innerWidth <= 600) {
        ...
        blContent.style.width = "25rem";
        blContent.style.height = "0";
        blContent.style.top = "35vh";
